  ...
  return (
    <>
      ...
      >
        ...
        <div className=" flex  flex-wrap justify-center animate-fade-up h-auto pt-20  pb-4 w-full via-light-yellow max-[600px]:pb-10 max-[600px]:pt-10">
          {data.staff.map((item) => (
            <button onClick={HandleClick(item)} key={item.key}>
              <div className=" w-72 mx-2 my-2  max-w-sm bg-dark-blue shadow-lg shadow-blue-500/50 border-gray-200 rounded-lg  hover:shadow-2xl">
                <div className="flex flex-col items-center px-8 py-10">
                  <Image
                    ...
                    alt="Bonnie image"
                  ></Image>
                  <h5 className="mb-1 text-xl text-center font-medium text-white ">
                    {item.name}
                  </h5>
        ...
        <Link
          href={"/MainStaff"}
          className="inline-flex items-center mt-0 px-3 py-2 text-sm font-medium text-center border-2 text-dark-blue bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300  "
        >
          See more
          <svg
