...
<footer className=" w-full bg-dark-blue dark:bg-gray-900">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="/" className=" text-white hover:underline">University of Lagos</a>
                      </li>
                      <li>
                          <a href="/" className=" text-white hover:underline">Research & Innovation Website</a>
                      </li>
                  </ul>
              </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-white sm:text-center dark:text-gray-400">  &copy;  2023 <a href="wartclor.com" className=" text-white hover:underline">Wartclor</a>. All Rights Reserved.
          </span>
